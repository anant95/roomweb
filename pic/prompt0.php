...
if($_SESSION['prompt0']){
$_SESSION['prompt0']=0;
 $message="An OTP has been sent to your mobile number.<br><br>Please enter the OTP to complete your registration.<br><br>";
...
function send(){
header('location:sendotp.php?action=verifyOTP');
}
?>
