...
if(is_numeric($x))
  {
      switch($x){
	      case 0: $message="Congratulations !!! <br><br>Your account is active now.<br><br>You may now <a href=\"index.php\">Login!</a> and Start Posting your <b>Room, shop, hostel, PG</b> for Rent";
		          break;
          case 1: $message="Your Account is not verified.Please Register Again!";
		          break;
