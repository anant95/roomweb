...
<nav class="navbar navbar-inverse">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
     ...
     <div class="container-fluid" style="height: 700px;background: rgba(0,80,50,.7);padding:10px;overflow: auto;">
			<div style="background: rgba(0,0,0,.5); padding:15px;">
					...
					<div class="row">
						...
						<form role="form"  id="dash_third_table" method="POST" action="search_locality.php?s=<?php echo $s.'&x='.$x.'&city='.$city;?>">
					  	   <div id="inner">
					         <div class="form-group">
						       
						       <label for="room_for">Locality:</label> 
		                        ...
		                        <?php  
						          ...
						          if($set_submit){
										  if(empty($city_err))
										    {
										       $query = "SELECT * from $y where $z = '$s' AND $c = '$city'  AND available=1";
											 ...
											 if (mysqli_num_rows($result)==0){
											  ...
											  echo "<label style='width:220px;'>";
									           echo "<p style='font-size:18px;color:white;'>  <input type='radio' name='locality' value='$row[$locality]'> $row[$locality] </p>";
									          echo "</label>";
										  	...
										  	echo "<p style='font-size:18px;color:white;font-weight:bold;'>Please Select City Name</p>";
										  }
								  }
					...
					if(!$flag)
					   {
						...
						if($y=='room_detail'){
						$data = "SELECT * from $y where $z = '$s' AND $c = '$city'  AND available=1";
