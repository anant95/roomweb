     ...
     <div class="wrapper" style="background-image: url('pic/back7.jpg');">
     	 ...
     	 <div class="container-fluid">
     	 	...
     	 	<div class="row">
     	 		...
     	 		<div class="col-md-3" id="dash_third_table">
     	 	    ...
     	 	    <div class="col-md-4 ">
						...
						<form role="form"  id="dash_third_table" method="POST">
						  	<div id="inner">
						  	<h2 id="login_header" style="color: white;">Hostel Detail</h2>
				  ...
				  <!-- Rent charges -->    
						    <div class="form-group"> 
						      ...
						      <div class="input-group">
						         ...
						         <input type="text" class="form-control" id="rent" required="required" name="rent" placeholder="Enter Rent for your room">
						      </div>
						    </div>
				           ...
				           <div class="form-group">
						    ...
						    <div class="form-group">
						    	   <label for="room_for">Facilities * :</label> 
									 ...
									 <textarea class="form-control" rows="3" name="facilities" id="facilities" placeholder="Additional Facilities and details about hostel you want to enter !"></textarea>
